...
NestJS implementation using a global interceptor and `better-sqlite3`. See [step-2-access-log.md](../step-2-access-log.md) for the schema and the rules this follows.
