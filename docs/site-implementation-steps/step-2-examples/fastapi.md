...
FastAPI middleware implementation. See [step-2-access-log.md](../step-2-access-log.md) for the schema and the rules this follows.
...
SKIP_PATHS = {"/health", "/health/agent", "/health/frontend-error"}
